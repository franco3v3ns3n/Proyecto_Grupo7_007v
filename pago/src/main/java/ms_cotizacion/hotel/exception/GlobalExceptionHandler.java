...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleHabitacionNotFound(HabitacionNotFoundException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleRemoteServiceException(RemoteServiceException ex) {
        ...
        response.put("error", "Error en comunicación con microservicio remoto");
